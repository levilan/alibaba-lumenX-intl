...
export default function VideoSidebar({ tasks, onRemix, onDeleteTask, params, setParams }: VideoSidebarProps) {
            ...
            <div className="flex-1 overflow-hidden relative">
                <AnimatePresence mode="wait">
                    {activeTab === "settings" ? (
                        ...
                        >
                            <VideoQueue tasks={tasks} onRemix={onRemix} onDelete={onDeleteTask} />
                        </motion.div>
                    )}
                </AnimatePresence>
            </div>
